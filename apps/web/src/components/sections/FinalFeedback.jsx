  ...
  const feedbackTexts = {
    oneStar: t(
      config?.feedbackTexts?.oneStar ||
        "🚨 تنبيه أمني خطير! تم رصد تقييم عدائي (1 نجمة). السيستم يعتبر هذا تهديداً لسلامة روقان محمد، وجاري تفجير الشاشة بقلوب ناعمة للدفاع عن النفس خلال {count} ثوانٍ..."
    ),
    twoStar: t(
      config?.feedbackTexts?.twoStar ||
        "ممم.. نجمتين؟ تحسن طفيف ولكن لا يليق بالملكة منار. جاري تفعيل بروتوكول الرشوة التلقائية..."
    ),
    threeStar: t(
      config?.feedbackTexts?.threeStar ||
        "3 نجوم؟ يعني صافي يا لبن بس كبرياء محمد مجروح شوية. جاري فحص ملفات السيرفر..."
    ),
    fourStar: t(
      config?.feedbackTexts?.fourStar ||
        "يا سلاام! 4 نجوم! وصلنا لـ 80% من الروقان الكامل. بس محمد محتاج النجمة الأخيرة دي عشان يعدي ترم هندسة الكمبيوتر بسلام 😂"
    ),
    fiveStar: t(
      config?.feedbackTexts?.fiveStar ||
        "كفاءة 100%! تم توثيق الصلح الشامل، وإعلان منار كأعظم ملكة في المجرة! 🥰❤️"
    ),
  };
