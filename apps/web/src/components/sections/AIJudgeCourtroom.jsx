...
export default function AIJudgeCourtroom({ onNext }) {
  ...
  }, [text, onNext, updateState, siteSlug, config, state]);
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-5">
      ...
      >
        ...
        <p className="mb-6 text-sm font-medium text-[#5A5955] dark:text-slate-300">
          {config?.locale === 'en' ? "The AI Judge is ready to hear your grievance" : "القاضي الذكي جاهز للاستماع لمرافعتك"}
        </p>
          ...
          >
            ...
            >
              ...
              <button
                type="button"
                onClick={onNext}
                className="inline-flex items-center gap-2 rounded-full bg-[#1A1A1A] dark:bg-white dark:text-[#1A1A1A] px-8 py-3 text-sm font-medium text-[#F4F3EF] hover:bg-[#DFBA73] transition-colors"
              >
