...
export default function SaaSOnboardingPage() {
  ...
  // Overhauled Relatable WhatsApp Interactive Story Pitch Hook
  ...
  // Hydrate global stats and content
  useEffect(() => {
    setIsMounted(true);
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#FCFBF7] dark:bg-gray-950 font-sans antialiased text-gray-900 dark:text-gray-100 relative transition-colors overflow-hidden">
      
      {/* MASTER STUNNING ELEGANT GATEWAY ENTRANCE (Buttery Fade-in) */}
      <motion.div
        key="master-portal"
      ...
      >
        ...
        <header className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-wrap items-center justify-between gap-4 z-40 relative border-b border-gray-200 dark:border-gray-800 shadow-sm bg-white/80 dark:bg-gray-950/80 backdrop-blur-xl transition-colors font-sans">
          ...
          >
            ...
            <span className="tracking-tight font-mono text-lg sm:text-xl font-extrabold">Safi.io</span>
          </button>
            ...
            <button
              ...
              className={`${TAB_BTN} ${
                activeTab === "wall"
                  ...
                  : "text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-sans font-medium"
              }`}
            >
          ...
          <AnimatePresence mode="wait">
                  ...
                  {apologies.length === 0 ? (
                    ...
                    apologies.map((apology) => (
                      <motion.div 
                        ...
                        className="p-5 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow text-xs sm:text-sm leading-relaxed flex flex-col justify-between space-y-2 font-medium"
                      >
                ...
                <form onSubmit={handleApologySubmit} className="flex flex-col sm:flex-row gap-3 relative z-10 font-sans">
                  <div className="flex-1 relative">
                    <input 
                      ...
                      className="w-full bg-gray-50 dark:bg-gray-800 p-4.5 rounded-2xl border border-gray-300 dark:border-gray-700 text-xs sm:text-sm font-bold outline-none focus:border-indigo-600 dark:focus:border-indigo-400 dark:text-white shadow-inner transition-colors font-sans"
                    />
                  ...
                  {stories.map((story, index) => {
                    ...
                    return (
                      <motion.div 
                        ...
                        className="p-8 bg-gray-50 dark:bg-gray-800 border border-amber-200 dark:border-gray-700 rounded-3xl flex flex-col justify-between gap-5 shadow-lg hover:shadow-2xl transition-all relative overflow-hidden group font-medium"
                      >
                        {badge}
            ...
            {activeTab === "gifts" && (
              ...
              >
                ...
                <form onSubmit={handleGenerateGift} className="bg-gray-50 dark:bg-gray-800 p-8 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-lg space-y-6 relative z-10 font-sans">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 font-sans">
                    ...
                    <div className="space-y-2 font-sans">
                      ...
                      <select 
                        ...
                        className="w-full bg-white dark:bg-gray-900 p-4.5 rounded-2xl border border-gray-300 dark:border-gray-600 text-sm font-black outline-none focus:border-rose-600 dark:text-white shadow-inner cursor-pointer font-sans"
                      >
              ...
              >
                ...
                <div className="space-y-6 relative z-10 font-sans font-medium">
                  {BLOG_POSTS_MOCK.map((post) => (
                    <article 
                      key={post.slug}
                      className="p-8 bg-gray-50 dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl transition-all flex flex-col justify-between space-y-4 font-sans"
                    >
                      <div>
