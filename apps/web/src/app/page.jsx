    ...
    <div className="flex min-h-screen flex-col bg-[#FCFBF7] dark:bg-gray-950 font-sans antialiased text-gray-900 dark:text-gray-100 relative transition-colors">
      ...
      <header className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-wrap items-center justify-between gap-4 z-40 relative border-b border-gray-200 dark:border-gray-800 shadow-sm bg-white/80 dark:bg-gray-950/80 backdrop-blur-xl transition-colors">
        ...
        <button
          ...
          className="flex items-center gap-2.5 font-black text-xl text-gray-900 dark:text-white cursor-pointer active:scale-95 transition-transform"
        >
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "wall" && (
            ...
            >
              ...
              {/* Scroller list */}
              <div className="flex-1 overflow-y-auto space-y-4 pr-2 mb-8 scrollbar-thin relative z-10">
                {apologies.length === 0 ? (
              ...
              <form onSubmit={handleApologySubmit} className="flex flex-col sm:flex-row gap-3 relative z-10">
                ...
                <button 
                  ...
                  className="bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white text-xs sm:text-sm font-black px-10 py-4.5 rounded-2xl transition-all cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/25"
                >
                  {apologyLoading ? (
                    <>
              ...
              {wallSuccess && (
                <motion.div 
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="absolute bottom-28 left-1/2 transform -translate-x-1/2 bg-green-600 text-white text-xs font-black px-6 py-3 rounded-full shadow-2xl flex items-center gap-2 z-20"
                >
          ...
          {activeTab === "stories" && (
            <motion.section 
              ...
              exit={{ opacity: 0, y: -20 }}
              transition={{ duration: 0.3 }}
              className={`${CARD} p-8 sm:p-12 max-w-5xl mx-auto relative overflow-hidden`}
            >
              ...
              <div className="mt-12 p-8 rounded-3xl bg-gradient-to-r from-amber-800 to-[#B45309] text-white flex flex-wrap items-center justify-between gap-6 shadow-2xl">
                <div className="max-w-xl">
                  ...
                  <p className="text-xs sm:text-sm text-amber-100 mt-1.5 font-medium leading-relaxed">
